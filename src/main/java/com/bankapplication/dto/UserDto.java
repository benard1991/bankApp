...
//    @Pattern(regexp = "\\d{13}", message = "Next of Kin phone number must be a 13-digit number.")
    ...
    private List<@Pattern(regexp = "\\d{10}", message = "Account number must be a 10-digit number.") String> accountNumbers;

//    @NotEmpty(message = "Role is required.")
//    private String role;

    @NotEmpty(message = "Role is required.")
    private List<@NotBlank(message = "Role cannot be blank.") String> role;
}
